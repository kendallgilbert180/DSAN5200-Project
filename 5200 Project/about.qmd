...
fig = px.sunburst(education_gdp, path=['Region','Country'], values='gdp', names = 'Country', title='GDP',color_discrete_sequence=px.colors.qualitative.Set3, hover_data=['gdp'])
# change the plot size
fig.update_layout(width=1000, height=800, plot_bgcolor='#f7ebdb', font_color='black', 
